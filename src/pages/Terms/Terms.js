        ...
        <div className="container">
          <p className="c6">
            <span className="c4">
              ...
              Uttaranchal Trading owned and operated by Kamal Enterprises, covering essential aspects for our online re-commerce
              platform operating in India.
            </span>
          </p>
          <p className="c6">
            <span className="c1">uttaranchaltrading.com owned and operated by Kamal Enterprises Terms &amp; Conditions</span>
          </p>
          <p className="c6">
          ...
          <p className="c6">
            <span className="c2">
              Welcome to uttaranchaltrading.com owned and operated by Kamal Enterprises (&quot;the Site&quot;). These Terms
              &amp; Conditions (&quot;Terms&quot;) govern your use of the Site
              and the purchase of products from Uttaranchal Trading owned and operated by Kamal Enterprises.
            </span>
          ...
          <ul className="c10 lst-kix_ui22japon8s6-0 start">
            <li className="c0 li-bullet-0">
              <span className="c4">
                ...
                images, and software is the property of Uttaranchal Trading owned and operated by Kamal Enterprises or its
          ...
          <ul className="c10 lst-kix_28a2ovzdh5yk-0 start">
            <li className="c0 li-bullet-0">
              <span className="c4">
                You agree to indemnify and hold Uttaranchal Trading owned and operated by Kamal Enterprises harmless from any
          ...
          <p className="c6">
            <span className="c1">
              By using the uttaranchaltrading.com owned and operated by Kamal Enterprises website, you acknowledge and agree
