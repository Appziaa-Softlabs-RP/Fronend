        ...
        <div className="container">
          <p className="c6">
            <span className="c4">
              ...
              AshiElectronics owned and operated by ASHI RETAIL ENTERPRISES, covering essential aspects for our online re-commerce
          ...
          <p className="c6">
            <span className="c2">
              ...
              and the purchase of products from AshiElectronics owned and operated by ASHI RETAIL ENTERPRISES.
            </span>
          ...
          <ul className="c10 lst-kix_ui22japon8s6-0 start">
            <li className="c0 li-bullet-0">
              <span className="c4">
                ...
                images, and software is the property of AshiElectronics owned and operated by ASHI RETAIL ENTERPRISES or its
          ...
          <ul className="c10 lst-kix_28a2ovzdh5yk-0 start">
            <li className="c0 li-bullet-0">
              <span className="c4">
                You agree to indemnify and hold AshiElectronics owned and operated by ASHI RETAIL ENTERPRISES harmless from any
