...
export const Faq = () => {
  ...
  const faqs = [
    {
      heading: "What is Uttaranchal Trading?",
      answer:
        "Uttaranchal Trading offers top-quality open-box electrical appliances at unbeatable prices. Discover a wide range of trusted brands with warranty and savings that fit your budget!",
    },
    {
      heading: "Are the items on Uttaranchal Trading brand new?",
      answer:
    ...
    {
      heading: "How much can I save by buying from Uttaranchal Trading?",
      answer:
        "Uttaranchal Trading offers unbeatable pricing with up to 80%* discounts on MRP depending on the product type.  We are more or less certain that our pricing remains the best across online or offline platforms pan India. To buy the products of your choice and check our amazing offers and discounts, click here: <a href='https://uttaranchaltrading.com/' target='_blank'>https://uttaranchaltrading.com/</a>.",
    },
    {
      heading: "Is Uttaranchal Trading a recognized company?",
      answer:
        "Yes, Uttaranchal Trading is a registered business entity having its head office in Delhi with nationwide distribution through company-owned outlets, franchises, business associates, and our online portal <a href='https://uttaranchaltrading.com/' target='_blank'>https://uttaranchaltrading.com/</a>. We use secure online e-commerce platform India's leading payment gateway Razorpay and deploy robust SSL security measures strictly following government regulations/compliances to keep our customers data privacy as the top most priority",
    },
    {
      heading: "How do I place an order?",
      answer:
        "<ul><li>Go to our website: <a href='https://uttaranchaltrading.com/' target='_blank'>https://uttaranchaltrading.com/</a></li><li>Use the search bar or browse through product categories to find the product of your choice</li><li>Click on the product you would like to purchase</li><li>If you like the product, click the '<strong>Add to Cart</strong>' button.</li><li>Once you are ready, click the '<strong>Proceed to Checkout</strong>' button.</li><li>You will be prompted to enter your email address and delivery address. Make sure all your information is accurate to avoid delays.</li><li>Provide additional phone number in the billing address if you have one</li><li>Select your preferred payment method from the available options</li><li>We offer secure payment gateways for credit cards, debit cards, net banking, and UPI</li><li>Review and Place Order: Review your order summary carefully, including product details, pricing, and delivery address</li><li>Once everything looks good, click the '<strong>Place Order</strong>' button.</li></ul>",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We use Razorpay <a href='https://uttaranchaltrading.com/' target='_blank'>https://uttaranchaltrading.com/</a> payment gateway for processing all the transactions. Razorpay is India's first full-stack financial solutions company compliant with leading industry standards such as ISO 27001, PCI DSS and SOC2.<br /><br />They are RBI Authorised Payment Aggregator, and fully ensures that your transactions are secure.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "You can reach us by phone - 9654675803 or email us at Uttaranchal Trading@gmail.com",
    },
    {
              ...
              <div className="accordion-item" key={index}>
                <h2 className="accordion-header" id={`heading${index + 1}`}>
                  <button
                    ...
                    className={`accordion-button ${visibleItem === index ? "" : "collapsed"
                      }`}
                    style={{
                      backgroundColor:
                ...
                <div
                  ...
                  className={`accordion-collapse ${visibleItem === index ? "show" : "collapse"
                    }`}
